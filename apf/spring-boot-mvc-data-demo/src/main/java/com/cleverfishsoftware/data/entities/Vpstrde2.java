...
@NamedQueries({
    @NamedQuery(name = "Vpstrde2.findAll", query = "SELECT v FROM Vpstrde2 v"),
    @NamedQuery(name = "Vpstrde2.findByProj1no", query = "SELECT v FROM Vpstrde2 v WHERE v.proj1no = :proj1no"),
    @NamedQuery(name = "Vpstrde2.findByProj1name", query = "SELECT v FROM Vpstrde2 v WHERE v.proj1name = :proj1name"),
    @NamedQuery(name = "Vpstrde2.findByResp1no", query = "SELECT v FROM Vpstrde2 v WHERE v.resp1no = :resp1no"),
    @NamedQuery(name = "Vpstrde2.findByResp1fn", query = "SELECT v FROM Vpstrde2 v WHERE v.resp1fn = :resp1fn"),
    @NamedQuery(name = "Vpstrde2.findByResp1mi", query = "SELECT v FROM Vpstrde2 v WHERE v.resp1mi = :resp1mi"),
    @NamedQuery(name = "Vpstrde2.findByResp1ln", query = "SELECT v FROM Vpstrde2 v WHERE v.resp1ln = :resp1ln"),
    @NamedQuery(name = "Vpstrde2.findByProj2no", query = "SELECT v FROM Vpstrde2 v WHERE v.proj2no = :proj2no"),
    @NamedQuery(name = "Vpstrde2.findByProj2name", query = "SELECT v FROM Vpstrde2 v WHERE v.proj2name = :proj2name"),
    @NamedQuery(name = "Vpstrde2.findByResp2no", query = "SELECT v FROM Vpstrde2 v WHERE v.resp2no = :resp2no"),
    @NamedQuery(name = "Vpstrde2.findByResp2fn", query = "SELECT v FROM Vpstrde2 v WHERE v.resp2fn = :resp2fn"),
    @NamedQuery(name = "Vpstrde2.findByResp2mi", query = "SELECT v FROM Vpstrde2 v WHERE v.resp2mi = :resp2mi"),
    @NamedQuery(name = "Vpstrde2.findByResp2ln", query = "SELECT v FROM Vpstrde2 v WHERE v.resp2ln = :resp2ln")})
public class Vpstrde2 implements Serializable {
